import { mysqlTable, mysqlSchema, AnyMySqlColumn, foreignKey, datetime, double, text, timestamp, date, varchar, int, time, index, mysqlEnum, unique, longtext, char, smallint, bigint, tinyint } from "drizzle-orm/mysql-core"
...
import { createInsertSchema } from "drizzle-zod";
  ...
  // Create schemas for essential tables to power our app
