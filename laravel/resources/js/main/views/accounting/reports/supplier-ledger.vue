...
export default defineComponent({
    ...
    setup() {
        ...
        return { loading, generated, suppliers, filters, reportData, tableRows, columns, fmt, formatDate, filterOption, typeColor, openingBalance, totalDebit, totalCredit, closingBalance, load, print };
    }
});
</script>
