...
export default {
    ...
    state() {
        return {
            ...
            isSubdomainModuleEnabled: window.config &&
                window.config.app_type &&
                window.config.app_type === 'saas' &&
                window.config.enabled_modules &&
                window.config.enabled_modules.includes("StockiflySaasSubdomain")
        }
    },
    ...
    mutations: {
        ...
        updateIsSubdomainModuleEnabled(state, isSubdomainModuleEnabled) {
            state.isSubdomainModuleEnabled = isSubdomainModuleEnabled;
        },
    },
